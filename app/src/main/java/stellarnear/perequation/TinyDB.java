...
public class TinyDB {
    ...
    public ArrayList<Family> getListAllFamilies(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Family> objects = new ArrayList<Family>();

        for (String jObjString : objStrings) {
            Family value = gson.fromJson(jObjString, Family.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListAllFamilies(String key, List<Family> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Family obj : objArray) {
