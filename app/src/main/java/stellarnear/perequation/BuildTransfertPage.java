        ...
        for (final Family famDon : currentTransfertManager.getDonateurs().asList()) {
            ...
            fam_don_name.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(famDon.getMails()!=null && famDon.getMails().length()>1 && !famDon.getMails().equalsIgnoreCase("null")&& !famDon.getMails().equalsIgnoreCase("aucun")){
                    ...
                    b.setPositiveButton("Envoyer", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            if (input.getText().toString().length() > 0) {
                                try {
                                    if(!input.getText().toString().trim().equalsIgnoreCase(famDon.getMails())) {
